...
- [x] **能力 B — 推导机械检查**(`check_algebra.py`:SymPy 代数/量纲/极限,例如能抓出 `(a+b)²≠a²+b²`、`E=mc` 量纲不符)
- [x] **能力 C — 整篇文档 / PPT 物理审查**(`review_doc.py`:单位/数量级 linter,例如标出 `5 m·rad` 的发射度、`|Δν|>1`,并产出 §6 逐条清单)
